...
//
vector<Trajectory> GlobalTruncRefitter::refit(const reco::Track& globalTrack, const int theMuonHitsOption) const {
  ...
  LogTrace(theCategory) << " *** GlobalTruncRefitter *** " << endl;
