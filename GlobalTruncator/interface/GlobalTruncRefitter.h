#ifndef UserCode_GlobalTruncator_GlobalTruncRefitter_H
#define UserCode_GlobalTruncator_GlobalTruncRefitter_H
...
class GlobalTruncRefitter {
  ...
  public:
    ...
    GlobalTruncRefitter(const edm::ParameterSet&, const MuonServiceProxy*);
          
    /// destructor
    virtual ~GlobalTruncRefitter();
