TLegend * note_glb_mabh_figures()
{
  ...
  TString dirName_("MultiTrack/globalMuons_tpToGlbMuonAssociation");
  TString figDirName_("global_mabh/glb");
  ...
  //-------------------------------
  TString dirNameRM_("RecoMuon_MuonAssoc/Glb");
