// -*- C++ -*-
//
// Package:    MyMuonAnalyzer
// Class:      MyMuonAnalyzer
// 
/**\class MyMuonAnalyzer MyMuonAnalyzer.cc AEverett/MyMuonAnalyzer/src/MyMuonAnalyzer.cc
...
class MyMuonAnalyzer : public edm::EDAnalyzer {
public:
  explicit MyMuonAnalyzer(const edm::ParameterSet&);
  ~MyMuonAnalyzer();
...
//
MyMuonAnalyzer::MyMuonAnalyzer(const edm::ParameterSet& iConfig) 
  :
...
void 
MyMuonAnalyzer::beginJob(const edm::EventSetup&)
{
...
float 
MyMuonAnalyzer::calculateDistance(const math::XYZVector& vect1, const math::XYZVector& vect2) {
...
//
TH1F* MyMuonAnalyzer::divideErr(TH1F* h1, TH1F* h2, TH1F* hout) {
...
DEFINE_FWK_MODULE(MyMuonAnalyzer)
