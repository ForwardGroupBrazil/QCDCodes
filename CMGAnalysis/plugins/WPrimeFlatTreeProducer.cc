...
#include "KKousour/CMGAnalysis/plugins/WPrimeFlatTreeProducer.h"
...
WPrimeFlatTreeProducer::WPrimeFlatTreeProducer(edm::ParameterSet const& cfg) 
{
...
//////////////////////////////////////////////////////////////////////////////////////////
void WPrimeFlatTreeProducer::beginJob() 
{
  ...
  //---------- W -----------------------------------------------
  outTree_->Branch("muMT"     ,&muMT_              ,"muMT_/F");
  outTree_->Branch("elMT"     ,&elMT_              ,"elMT_/F");
  //---------- di-jets -----------------------------------------
...
//////////////////////////////////////////////////////////////////////////////////////////
void WPrimeFlatTreeProducer::endJob() 
{
  delete QGL_;
  delete elP4_;
  delete elPt_;
...
//////////////////////////////////////////////////////////////////////////////////////////
void WPrimeFlatTreeProducer::initialize()
{
  run_          = -999;
  evt_          = -999;
  lumi_         = -999;
...
void WPrimeFlatTreeProducer::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup) 
{
  initialize();
  ...
  if (nVtx_ > 0 && (nelectrons_ > 0 || nmuons_ > 0) && njets_ > 0) {
    if (njets_ > 1) {
    ...
    if (nmuons_ > 0) {
      muMT_ = sqrt(2*(*muPt_)[0]*met_*(1-cos(deltaPhi((*muPhi_)[0],metPhi_))));
    }
    if (nelectrons_ > 0) {   
      elMT_ = sqrt(2*(*elPt_)[0]*met_*(1-cos(deltaPhi((*elPhi_)[0],metPhi_))));
    }
    outTree_->Fill();
  }
}
//////////////////////////////////////////////////////////////////////////////////////////
WPrimeFlatTreeProducer::~WPrimeFlatTreeProducer() 
{
}

DEFINE_FWK_MODULE(WPrimeFlatTreeProducer);
