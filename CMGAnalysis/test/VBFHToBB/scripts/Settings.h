...
#define _Settings_h
//---- signal masses ----------------
const int H_MASS[5] = {115,120,125,130,135};
...
const float XSEC_SIGNAL[5] = {1.215,1.069,0.911,0.746,0.585};
const float XSEC_GLUGLU[5] = {16.14,13.69,11.26,8.93,6.78};
//---- number of MC events ----------
...
const int N_GLUGLU[5] = {999908,999908,999908,999908,999908};
//---- luminosity in 1/pb -----------
const float LUMI = 18530.;
