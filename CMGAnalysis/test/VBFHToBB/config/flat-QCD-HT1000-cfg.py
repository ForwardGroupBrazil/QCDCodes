...
process.source = datasetToSource('cmgtools','/QCD_HT-1000ToInf_TuneZ2star_8TeV-madgraph-pythia6/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM/V5_B/PAT_CMG_V5_13_0','cmgTuple_.*.root')
...
process.p = cms.Path(process.Hbb * process.HbbCHS)
