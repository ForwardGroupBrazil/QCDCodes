...
process.source = datasetToSource('cmgtools','/MultiJet/Run2012A-13Jul2012-v1/AOD/PAT_CMG_V5_12_0','cmgTuple_.*.root')
...
process.json = cms.EDAnalyzer('JSONProducer',
  filename = cms.string("json_MultiJet-Run2012A.txt")
)
