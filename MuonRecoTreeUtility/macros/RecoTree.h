...
#include "string.h"
	...
	Int_t	l3NDTHits.first;
	Int_t	l3NDTHits.second;
	Int_t	l3NCSCHits.first;
	Int_t	l3NCSCHits.second;
	Int_t	l3NRPCHits.first;
	Int_t	l3NRPCHits.second;
	...
	map<int,vector<int> >	*muNCSCSegArb;
	map<int,vector<int> >	*muNDTSegArb;
	map<int,vector<int> >	*muNRPCSegArb;
	vector<double>	*l3P;
	vector<double>	*l3Px;
	vector<double>	*l3Py;
	vector<double>	*l3Pz;
	...
	map<int,int>	*l3NDTHits;
	map<int,int>	*l3NCSCHits;
	map<int,int>	*l3NRPCHits;
	...
	map<int,vector<int> >	*tkTrackDetIds;
	map<int,vector<int> >	*tkTrackSubdetIds;
	map<int,vector<int> >	*tkTrackRecHitsStatus;
	map<int,vector<double> >	*tkTrackRecHitsX;
	map<int,vector<double> >	*tkTrackRecHitsY;
	map<int,vector<double> >	*tkTrackRecHitsZ;
	vector<double>	*l2P;
	vector<double>	*l2Px;
	vector<double>	*l2Py;
	vector<double>	*l2Pz;
	...
	map<int,vector<int> >	*tkTrackAssociatedSimMuonDetIds;
