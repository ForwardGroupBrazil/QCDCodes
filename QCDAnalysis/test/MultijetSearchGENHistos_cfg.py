...
process.TFileService=cms.Service("TFileService",fileName=cms.string('MultijetSearchGENHistos_8j_pythia_Pt50.root'))
...
##-------------------- User analyzer  --------------------------------
process.multijet    = cms.EDAnalyzer('MultijetSearchGENHistos',
    ...
    scale4j         = cms.double(2.0),
    offset4j        = cms.double(200),
    rank            = cms.int32(8),
    nEvents         = cms.int32(-1),
