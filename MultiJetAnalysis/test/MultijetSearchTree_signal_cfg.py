...
process.TFileService=cms.Service("TFileService",fileName=cms.string('MultijetSearchTree_axiaxi800.root'))
...
process.multijet    = cms.EDAnalyzer('MultijetSearchTree',
    filenames       = cms.vstring('/uscms_data/d2/kkousour/ProcessedTree_axiaxi800.root'),
