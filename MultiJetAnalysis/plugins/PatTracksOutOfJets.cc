...
// $Id: PatTracksOutOfJets.cc,v 1.1 2012/02/15 12:40:29 kkousour Exp $
//
//
...
void PatTracksOutOfJets::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   using namespace std;
...
void PatTracksOutOfJets::beginJob()
{
}

void PatTracksOutOfJets::endJob() 
{
}
