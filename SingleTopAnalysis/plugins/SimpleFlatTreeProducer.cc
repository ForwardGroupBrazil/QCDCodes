...
#include "KKousour/SingleTopAnalysis/plugins/SimpleFlatTreeProducer.h"
...
SimpleFlatTreeProducer::SimpleFlatTreeProducer(edm::ParameterSet const& cfg) 
{
...
//////////////////////////////////////////////////////////////////////////////////////////
void SimpleFlatTreeProducer::beginJob() 
{
...
//////////////////////////////////////////////////////////////////////////////////////////
void SimpleFlatTreeProducer::endJob() 
{
}
//////////////////////////////////////////////////////////////////////////////////////////
void SimpleFlatTreeProducer::initialize()
{
  run_          = -999;
  evt_          = -999;
  nVtx_         = -999;
...
void SimpleFlatTreeProducer::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup) 
{
...
//////////////////////////////////////////////////////////////////////////////////////////
SimpleFlatTreeProducer::~LowerMultiplicityTree() 
{
}

DEFINE_FWK_MODULE(SimpleFlatTreeProducer);
